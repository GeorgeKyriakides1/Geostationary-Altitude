...
// GeoAltitude.java
// A Java program I created for calculating the geostationary altitude of any planet in our solar system which has one class that contains only one method main().
